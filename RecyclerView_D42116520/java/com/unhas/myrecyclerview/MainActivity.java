...
public class MainActivity extends AppCompatActivity {
    ...
    public ArrayList<President> getListData(){
        President president = null;
        ArrayList<President> listPresident = new ArrayList<>();
        for (int i = 0; i < dataName.length; i++) {
            president = new President();
            president.setName(dataName[i]);
            president.setRemarks(dataDescription[i]);
            president.setPhoto(dataPhoto.getResourceId(i,-1));
            listPresident.add(president);
        }
